...
namespace API.Data
{
    public class MessageRepository : IMessageRepository
    {
        ...
        {
            //Find can't be used with include, so we need to use SingleOrDefault
        ...
        //1 -> Get the conversation of the users
        //2 -> Find if there's any unreadMessages for the currentUser that recieve and mark them as read
        //3 -> return MessageDto
        public async Task<IEnumerable<MessageDto>> GetMessageThread(string currentUsername, string recipientUsername)
        {
            //Sender currentUsername or recipientUsername

            //if sender = currentUsername then Recipient = recipientUsername
            //OR
            //if sender = recipientUsername then Recipient = currentUsername
            ...
            .ProjectTo<MessageDto>(_mapper.ConfigurationProvider) //optimize query
            .ToListAsync();
            //--- 1 ---
